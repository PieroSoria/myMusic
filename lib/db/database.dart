...
class BaseSQL {
  ...
  _createDB(Database db, int version) async {
    await db.execute(
        "CREATE TABLE IF NOT EXISTS listadeplaylist(id TEXT PRIMARY KEY, nombre TEXT)");
    // await db.execute(
    //     "CREATE TABLE IF NOT EXISTS listademusic(id REAL PRIMARY KEY, playlist TEXT, nombre TEXT)");
    await db.execute(
